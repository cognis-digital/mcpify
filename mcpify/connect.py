"""Native cognis-connect emit for mcpify — forward findings to any platform.

Maps mcpify's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    mcpify ... --format json | mcpify-emit --to stix
    mcpify-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
